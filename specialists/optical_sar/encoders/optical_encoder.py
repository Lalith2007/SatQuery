"""Optical modality encoder implementation for Division 4."""
...
class OpticalEncoder(BaseModalityEncoder):
    """Replaceable Optical feature extraction encoder wrapping ResNet backbones."""
