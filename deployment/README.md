...
| :--- | :--- | :--- | :--- | :--- |
| **Division 2** | VQA, Grounding, Captioning | Qwen2.5-VL-3B-Instruct | `Lalith47/SatQuery-Models` (`stage1-baseline`) | **3,754,622,976 params** (6.99 GB) |
...
- **Decoupled Model Hub:** The 7 GB vision-language model weights reside in the dedicated model repository `Lalith47/SatQuery-Models` under immutable revision `stage1-baseline`. The Space repository remains lightweight without binary weights in Git history.
